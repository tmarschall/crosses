...
__global__ void euler_est(int nCross, int *pnNPP, int *pnNbrList, double dL, double dGamma,
			  double dStrain, double dStep, double *pdX, double *pdY, double *pdPhi, double *pdR,
			  double *pdAx, double *pdAy, double *pdMOI, double *pdIsoC, double *pdFx, double *pdFy,
...
__global__ void heun_corr(int nCross, int *pnNPP,int *pnNbrList,double dL, double dGamma, 
			  double dStrain, double dStep, double *pdX, double *pdY, double *pdPhi, double *pdR,
			  double *pdAx, double *pdAy, double *pdMOI, double *pdIsoC, double *pdFx,
